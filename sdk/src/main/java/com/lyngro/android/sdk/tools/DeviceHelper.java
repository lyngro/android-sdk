 ...
 *
 */
package com.lyngro.android.sdk.tools;
...
public class DeviceHelper {
    private static final String LOGGER_TAG = Lyngro.LOGGER_PREFIX + "DeviceHelper";
    ...
    public static int[] getResolution(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            ...
            // Reflection bad, still this is the best way to get an accurate activity size on API14-16.
            try {
