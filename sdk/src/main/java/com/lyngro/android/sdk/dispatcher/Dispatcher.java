...
package com.lyngro.android.sdk.dispatcher;
...
public class Dispatcher {
    private static final String LOGGER_TAG = Lyngro.LOGGER_PREFIX + "Dispatcher";
    ...
    private final int MAX_REQUREST_LENGTH_FOR_GET_METHOD = 2000;

    public Dispatcher(Lyngro lyngro, URL apiUrl, String authToken) {
        mLyngro = lyngro;
        mApiUrl = apiUrl;
        ...
        public void run() {
            ...
            while (mRunning) {
                ...
                while (pageIterator.hasNext()) {
                    ...
                    if (page.elementsCount() > 1 || wrapper.getEventUrl(page).toString().length() > MAX_REQUREST_LENGTH_FOR_GET_METHOD) {
